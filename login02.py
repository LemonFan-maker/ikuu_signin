...
Email02 = os.environ.get('Email02')
Pass02 = os.environ.get('Pass02')

driver.get("https://ikuuu.pw/auth/login")
sleep(5)
driver.find_element(By.XPATH, "/html/body/div[1]/section/div/div/div/div[2]/form/div/div[1]/input").send_keys(str(Email02))
sleep(1)
driver.find_element(By.XPATH, "/html/body/div[1]/section/div/div/div/div[2]/form/div/div[2]/input").send_keys(str(Pass02))
sleep(1)
